/**
 * LCMS PRO - Nigerian States and Local Government Areas (LGAs) Reference Dataset
 */
...
export const NIGERIAN_STATES_AND_LGAS: StateLgaMap = {
  "Abia": [
  ...
  "Akwa Ibom": [
    ...
    "Nsit-Ibiom", "Nsit-Ubium", "Obot Akara", "Okobo", "Onna", "Oron", 
  ...
  "Bauchi": [
    ...
    "Misau", "Ningi", "Tafawa Balewa", "Toro", "Warji", "Zaki"
  ],
  "Bayelsa": [
  ...
  "Kano": [
    ...
    "Garko", "Garun Mallam", "Gaya", "Gezawa", "Gwale", "Karaye", "Kibiya", 
    "Kano Municipal", "Kumbotso", "Kunchi", "Kura", "Madobi", "Makoda", 
  ...
  "Kebbi": [
    ...
    "Maiyama", "Ngaski", "Sakaba", "Shanga", "Suru", "Danko/Wasagu", "Yauri", "Zuru"
  ],
  "Kogi": [
  ...
  "Niger": [
    ...
    "Mariga", "Mokwa", "Moya", "Paikoro", "Rafi", "Rijau", "Shiroro", 
  ...
  "Ondo": [
    ...
    "Ile Oluji/Okeigbo", "Irele", "Okitipupa", "Ondo East", "Ondo West", "Ose", "Owo"
  ],
  "Osun": [
    "Atakunmosa East", "Atakunmosa West", "Ayedaade", "Ayedire", "Boluwaduro", 
    "Boripe", "Ede North", "Ede South", "Egbedore", "Ejigbo", "Ife Central", 
    "Ife East", "Ife North", "Ife South", "Ila", "Ilesa East", "Ilesa West", 
...
export const NIGERIAN_STATES = Object.keys(NIGERIAN_STATES_AND_LGAS).sort();

/**
 * Approved Cooperative Operating States for Lightway Cooperative Management System
 */
export const APPROVED_OPERATING_STATES = [
  'Lagos',
  'Oyo',
  'Ekiti',
  'Osun',
